...
1. Create класс используется для получения от пользователя данных, необходимых для создания новой сущности и ничего более.
2. Другой класс используется для вывода информации об этой сущности и дополняется информацией, которая генерируется на сервере.
"""
